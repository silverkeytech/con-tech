...
{ 
	...
	namespace ProjectViewLlblViewTypes
	{
		...
		public partial class ViewLevel
		{
			...
			[DataMember]
			public List<ViewLevelTypes.LevelChild> LevelChildren { get; set; }
		...
		namespace ViewLevelTypes
		{
			/// <summary> DTO class which is derived from the entity 'LevelChild (ViewLevels.LevelChildren)'.</summary>
			[Serializable]
			[DataContract]
